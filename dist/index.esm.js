...
var css_248z$b = "@import url(\"https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap\");:root{--qcuicq-color-primary:#294197;--qcuicq-color-primary-light:#435bb3;--qcuicq-color-primary-lighter:#768ee2;--qcuicq-color-secondary:#d81d0d;--qcuicq-color-secondary-light:#f05c5c;--qcuicq-color-secondary-lighter:#e9a39d;--qcuicq-color-tertiary:#318c56;--qcuicq-color-tertiary-light:#54a776;--qcuicq-color-tertiary-lighter:#81d2a2;--qcuicq-color-light:#ececec;--qcuicq-color-lighter:#f6f6f6;--qcuicq-color-error:#f05c5c;--qcuicq-color-textPrimary:#6b6b6b;--qcuicq-color-textSecondary:#bababa;--qcuicq-color-textDark:#242424;--qcuicq-color-textLight:#c8c8c8;--qcuicq-color-textError:#f05c5c;--qcuicq-color-textDefault:#fff;--qcuicq-btn-size-sm-padding:15px 18px;--qcuicq-btn-size-sm-height:25px;--qcuicq-btn-size-sm-font:.7rem;--qcuicq-btn-size-md-padding:18px 23px;--qcuicq-btn-size-md-height:28px;--qcuicq-btn-size-md-font:.8rem;--qcuicq-btn-size-lg-padding:21px 26px;--qcuicq-btn-size-lg-height:31px;--qcuicq-btn-size-lg-font:.9rem}body{font-family:Roboto,sans-serif}";
...
var css_248z$7 = ".Stepper-module_StepperWrapper__C4Prs{align-items:center;display:flex;flex-direction:column;justify-content:space-between;min-height:300px}.Stepper-module_StepIndicatorText__-gaHC{color:var(--qcuicq-color-textLight);font-size:.7rem;margin-top:15px;text-align:center}";
