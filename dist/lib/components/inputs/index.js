...
var Button = function Button(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: classnames(styles$1.Button, variant && styles$1["Button_Variant__".concat(variant)], size && styles$1["Button_Size__".concat(size)], disabled && styles$1.Button_Disabled, ButtonStyles !== null && ButtonStyles !== void 0 ? ButtonStyles : ""),
...
var _excluded$1 = ["type", "name", "placeholder", "inputRef", "errorMsg", "helperMsg", "InputTextStyles"];
...
var InputText = function InputText(props) {
  var type = props.type,
      ...
      other = _objectWithoutProperties(props, _excluded$1); // console.log(inputRef)
...
reactTextMask.MaskedInput;
reactTextMask.reactTextMask;

var _excluded = ["type", "name", "placeholder", "placeholderChar", "inputRef", "errorMsg", "helperMsg", "InputTextStyles", "mask", "control", "validation"];
...
var InputMask = function InputMask(props) {
  props.type;
      ...
      props.validation;
      _objectWithoutProperties(props, _excluded); // console.log(ref)
...
export { Button, InputMask, InputText };
